...
public class AtlasThread extends Thread implements DownloadJobListener, DownloadControlerListener {
	...
	protected void createAtlas() throws InterruptedException, IOException {
		...
		else if (atlasInterface.getOutputFormat() == AtlasOutputFormat.BigPlanet) {
			MapsToSQLiteDBCreator.createSQLiteDB(atlasDir, atlasDir.getParent()+"/BigPlanet_maps.sqlitedb");
			MapsToSQLiteDBCreator.deleteDir(atlasDir);
			atlasDir.deleteOnExit();
		}
